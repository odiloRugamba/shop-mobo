...
import AnnouncementModal from '../../components/models/Announcement'
...
const anouncements = [
  ...
  return (
    <View style={{flex: 1}}>
      ...
      />
      <FloatingBtn showModel={openModel}></FloatingBtn>
      <AnnouncementModal show={modalVisible} prop={props} hide={closeModel}/>
    </View>
  );
};
